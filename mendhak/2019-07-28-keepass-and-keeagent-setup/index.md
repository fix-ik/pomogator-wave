...
opengraph:
  image: /static/image/mendhak/keepass-ssh/keepass-ssh-key-9.png
---
...
![GDrive example](/static/image/mendhak/keepass-ssh/keepass-in-gdrive.png)
...
![git bin folder](/static/image/mendhak/keepass-ssh/git-bin-folder.png)
...
![plgx in plugins folder](/static/image/mendhak/keepass-ssh/keeagent-install-plgx.png)
...
![](/static/image/mendhak/keepass-ssh/github-clone.png)
...
![Github SSH key](/static/image/mendhak/keepass-ssh/ssh-key-paste.png)
...
![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-1.png)

Now for the keys.  Click on the *Advanced* tab and choose to attach files. 

![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-2.png)

Find your SSH keypair for your remote server and attach them

![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-3.png)
...
![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-4.png)
...
![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-5.png)

Another way to check which keys are loaded is by *Tools* > *KeeAgent*

![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-6.png)
...
![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-7.png)
...
![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-8.png)
...
![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-9.png)
...
![](/static/image/mendhak/keepass-ssh/keepass-ssh-key-10.png)
