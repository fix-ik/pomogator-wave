...
opengraph: 
  image: /static/image/mendhak/paper-sizes-standard/001preview.png
...
![Maintain ratio while folding](/static/image/mendhak/paper-sizes-standard/001preview.png)
...
![](/static/image/mendhak/paper-sizes-standard/002.png)

Move the x and y across the equal sign, and we get:

![](/static/image/mendhak/paper-sizes-standard/003.png)

Reducing it finally gives us the ratio,

![](/static/image/mendhak/paper-sizes-standard/004.png)
...
![Solving for `x`](/static/image/mendhak/paper-sizes-standard/006.png)

Which is [`1.1892071150...`](https://www.wolframalpha.com/input/?i=4th+root+of+2)

And solve for y by substituting x=1/y.

![Solving for `y`](/static/image/mendhak/paper-sizes-standard/007.png)
...
![B0](/static/image/mendhak/paper-sizes-standard/008.png)
